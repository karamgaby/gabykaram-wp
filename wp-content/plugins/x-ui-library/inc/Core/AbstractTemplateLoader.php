 ...
 *
 * @package   AbstractTemplateLoader
 * @author    Gary Jones
...
abstract class AbstractTemplateLoader {
   ...
   * @var string
   */
  protected $filter_prefix = 'x_ui_library';
   ...
   * @var string
   */
  protected $theme_template_directory = 'x-ui-library';
   ...
   * @var string
   */
  protected $plugin_directory = X_UI_LIBRARY_PLUGIN_DIR_PATH;
