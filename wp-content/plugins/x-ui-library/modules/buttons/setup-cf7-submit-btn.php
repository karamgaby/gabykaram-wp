...
add_action( 'wpcf7_init', 'x_wpcf7_add_form_tag_submit', 10, 0 );

function x_wpcf7_add_form_tag_submit() {
  wpcf7_add_form_tag( 'x_submit', 'x_wpcf7_submit_form_tag_handler' );
}

function x_wpcf7_submit_form_tag_handler( $tag ) {
  $class = wpcf7_form_controls_class( $tag->type, 'wpcf7-x_submit' );
...
add_action( 'wpcf7_admin_init', 'x_wpcf7_add_tag_generator_submit', 55, 0 );

function x_wpcf7_add_tag_generator_submit() {
  $tag_generator = WPCF7_TagGenerator::get_instance();
  $tag_generator->add( 'submit', __( 'submit', 'contact-form-7' ),
    'x_wpcf7_tag_generator_submit', array( 'nameless' => 1 ) );
}

function x_wpcf7_tag_generator_submit( $contact_form, $args = '' ) {
