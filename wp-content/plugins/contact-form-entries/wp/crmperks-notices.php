...
//var_dump($link);
				if ( ! class_exists( 'cfx_form' ) ) {
					...
					$msg = sprintf( __( '%sCRM Perks Forms Plugin%s is a free lightweight contact form builder and designer with floating buttons and popups.',
						'contact-form-entries' ),
						'<a href="https://wordpress.org/plugins/crm-perks-forms/" target="_blank">',
						'</a>' );
					?>
                  <div class="notice-warning settings-error notice is-dismissible" style="font-weight: bold">
<p><?php
	echo wp_kses_post( $msg ); ?></p>
<p><a href="<?php
	echo esc_url( $url ) ?>"><?php
		echo esc_html( $plugin_msg ); ?></a> | <a href="<?php
	echo esc_html( $link ); ?>"><?php
		_e( 'Dismiss this notice', 'contact-form-entries' ); ?></a></p>
</div>
					<?php
				}
			}
  ...
  <style type="text/css"> .vx_msg a {color: #fff; text-decoration: underline;}
      .vx_msg a:hover {color: #eee} </style>
  <div style="background-color: rgba(224, 224, 224, 0.5);  padding: 5px; margin: 0px 10px 10px 28px "><div style="background-color: #d54d21; padding: 5px 10px; color: #fff"
                                                                                                           class="vx_msg"> <span class="dashicons dashicons-info"></span> <?php
		...
		public function admin_footer( $text ) {
			if ( isset( $_GET['page'] ) && $_GET['page'] == vxcf_form::$id ) {
				$text = sprintf( __( 'if you enjoy using %sContact Form Entries Plugin%s, please %s leave us a %s rating%s. A %shuge%s thank you in advance.',
					'contact-form-entries' ),
					'<b>',
					'</b>',
					'<a href="' . $this->review_link . '" target="_blank" rel="noopener noreferrer">',
					'&#9733;&#9733;&#9733;&#9733;&#9733;',
					'</a>',
					'<b>',
					'</b>' );
  ...
  <p><?php
	  echo sprintf( __( 'You\'ve been using Contact Form Entries Plugin for some time now; we hope you love it!.%s If you do, please %s leave us a %s rating on WordPress.org%s to help us spread the word and boost our motivation.',
		  'contact-form-entries' ),
		  '<br/>',
		  '<a href="' . esc_html( $this->review_link ) . '" target="_blank" rel="noopener noreferrer">',
		  '&#9733;&#9733;&#9733;&#9733;&#9733;',
		  '</a>' ); ?></p>
  <p><a href="<?php
	  echo esc_html( $this->review_link ) ?>" class="vxcf_close_notice_a" target="_blank" rel="noopener noreferrer"><?php
		  _e( 'Yes, you deserve it', 'contact-form-entries' ) ?></a> | <a href="#" class="vxcf_close_notice_a"><?php
		  _e( 'Dismiss this notice', 'contact-form-entries' ); ?></a></p>
        </div>
...
<p>
<a href="<?php
echo esc_url( $plugin_url ) ?>" target="_blank" class="button-primary button">Go Premium</a>
</p>
</div>
...
<h2 style="text-align: center; font-size: 24px;">Premium Features</h2>
  ...
  <div class="vx_row">
        <div class="vx_row_inner">
            <div class="col-1">
                <img src="<?php
                echo esc_url( $url ) ?>images/premium/entries-stats.png" alt="Entries Stats" />
            </div>
            <div class="col-2">
        ...
        <p><a href="<?php
	        echo esc_url( $plugin_url ) ?>" target="_blank" class="button-primary button">Go Premium</a></p>
            </div>
        </div>
    </div>
    ...
    <p>Don't miss out on any potential leads. Collect data in real time as it is entered on your forms.</p>
        <p><a href="<?php
            ...
            <div class="col-1">
                <img src="<?php
                echo esc_url( $url ) ?>images/premium/partial-entries.png" alt="Partial Entries" />
            </div>
       ...
       <div class="vx_row">
        <div class="vx_row_inner">
            <div class="col-1">
             <img src="<?php
             echo esc_url( $url ) ?>images/premium/link-entries.png" alt="Link Entries and Contacts" />
    ...
    <div class="vx_row">
        ...
        <p><a href="<?php
	        echo esc_url( $plugin_url ) ?>" target="_blank" class="button-primary button">Go Premium</a></p>
              ...
              <div class="col-1">
                <img src="<?php
                echo esc_url( $url ) ?>images/premium/marketing-data.png" alt="Premium Features" />
            </div>
        </div>
    </div>
    <div class="vx_row  clear">
        ...
        <div class="col-1">
                <img src="<?php
                echo esc_url( $url ) ?>images/premium/location-map.png" alt="Geolocation Tracking" />
            </div>
            <div class="col-2">
                <div class="vx_row_title">
    ...
    <div class="vx_row  clear">
       ...
       <p><a href="<?php
	       echo esc_url( $plugin_url ) ?>" target="_blank" class="button-primary button">Go Premium</a></p>
            ...
            <div class="col-1">
                <img src="<?php
                echo esc_url( $url ) ?>images/premium/analytics.png" alt="Browsing History" />
            </div>
        </div>
    </div>
        <div class="vx_row  clear">
        <div class="vx_row_inner">
          <div class="col-1">
                <img src="<?php
                echo esc_url( $url ) ?>images/premium/lead-scoring.png" alt="Lead Scoring" />
            </div>
            <div class="col-2">
                <div class="vx_row_title">
                    <h2>Lead Scoring</h2>
    ...
    <p>You can set a score to each page.We show aggregate score along with browsing history. Lead score is basically "interest score" of a customer</p>
        ...
        <div class="vx_row_inner">
            ...
            <div class="col-2">
              ...
              <p><a href="<?php
	              echo esc_url( $plugin_url ) ?>" target="_blank" class="button-primary button">Go Premium</a></p>         </div>
                <div class="col-1">
                <img src="<?php
                echo esc_url( $url ) ?>images/premium/customer-platform.png" alt="Customer Platform" />
            </div>
        </div>
    </div>
            <div class="vx_row  clear">
        <div class="vx_row_inner">
          <div class="col-1">
                <img src="<?php
                echo esc_url( $url ) ?>images/premium/fields-mapping.png" alt="Fields Mapping" />
            </div>
            <div class="col-2">
                <div class="vx_row_title">
    ...
    <div class="vx_row  clear">
        <div class="vx_row_inner">
         <div class="col-2">
            ...
            <div class="col-1">
                <img src="<?php
                echo esc_url( $url ) ?>images/premium/email-lookup.png" alt="Email Lookup" />
            </div>
        ...
        <div class="vx_row_inner">
         <div class="col-1">
                <img src="<?php
                echo esc_url( $url ) ?>images/premium/phone-lookup.png" alt="Phone Lookup" />
            </div>
            <div class="col-2">
                <div class="vx_row_title">
                    <h2>Phone Lookup</h2>
    ...
    <p>Verify lead's phone number and get detailed information about phone number using phone lookup apis, We support many good phone lookup apis like everyoneapi , whitepages api , twilio api and numverify api.</p>
        ...
        <div class="vx_row_inner">
         <div class="col-2">
            ...
            <div class="col-1">
                <img src="<?php
                echo esc_url( $url ) ?>images/premium/weather-api.png" alt="Weather Information" />
            </div>
...
<div class="vx_row  clear">
        <div class="vx_row_inner">
             <div class="col-1">
                <img src="<?php
                echo esc_url( $url ) ?>images/premium/notification.png" alt="Notifications" />
            </div>
            <div class="col-2">
                <div class="vx_row_title">
                    <h2>Notifications</h2>
  ...
  <div class="vx_row  clear">
        <div class="vx_row_inner">
         <div class="col-2">
            ...
            <div class="col-1">
                <img src="<?php
                echo esc_url( $url ) ?>images/premium/entries-feeds.png" alt="Entries Feeds" />
            </div>
        ...
        <div class="col-1">
                <img src="<?php
                echo esc_url( $url ) ?>images/premium/zapier.png" alt="Zapier" />
            </div>
            <div class="col-2">
                <div class="vx_row_title">
