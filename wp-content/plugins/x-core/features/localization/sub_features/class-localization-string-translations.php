...
class X_Core_Localization_String_Translations extends X_Core_Sub_Feature {
  ...
  public function setup() {
    ...
    // var: key
    $this->set('key', 'x_core_localization_string_translations');
   ...
   */
  public function run() {
    add_action('init', array($this, 'x_core_string_registration'));
  }

  /**
   * String translations
   */
  public static function x_core_string_registration() {

    if (function_exists('pll_register_string')) {
      $group_name = get_bloginfo();
      $strings = x_core_get_registered_strings();
...
if (!function_exists('ask__')) {
  ...
  function ask__($key, $lang = null) {
    ...
    x_core_debug_msg('Localization error - Missing string by key {' . $key . '}', array('ask__', 'ask_e'));
...
if (!function_exists('asv__')) {
  ...
  function asv__($value, $lang = null) {
    ...
    // debug missing strings
    x_core_debug_msg('Localization error - Missing string by value {' . $value . '}', array('asv__', 'asv_e'));
