 ...
 */
class X_Core_Admin_Menu_Cleanup extends X_Core_Sub_Feature {

  public function setup() {

    // var: key
    $this->set('key', 'x_core_admin_menu_cleanup');
   ...
   */
  public function run() {
    add_action('admin_menu', array($this, 'x_core_cleanup_admin_menu'), 9999);
  }
   ...
   */
  public static function x_core_cleanup_admin_menu() {
