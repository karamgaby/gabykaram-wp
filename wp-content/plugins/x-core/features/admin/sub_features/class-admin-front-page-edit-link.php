 ...
 */
class X_Core_Admin_Front_Page_Edit_Link extends X_Core_Sub_Feature {

  public function setup() {

    // var: key
    $this->set('key', 'x_core_admin_front_page_edit_link');
   ...
   */
  public function run() {
    add_action('admin_menu', array($this, 'x_core_add_edit_link_to_front_page'));
  }

  /**
   * Add link to pages menu to edit front page
   */
  public static function x_core_add_edit_link_to_front_page() {
