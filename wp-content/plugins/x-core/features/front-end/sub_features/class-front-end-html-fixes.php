...
class Axio_Core_Front_End_Html_Fixes extends Axio_Core_Sub_Feature {
  ...
  public function setup() {
    ...
    // var: key
    $this->set('key', 'x_core_front_html_fixes');
   ...
   */
  public function run() {
    add_filter('next_posts_link_attributes', array($this, 'x_core_next_posts_attributes'));
    add_filter('script_loader_tag', array($this, 'x_core_cleanup_script_tags'));
  }
   ...
   */
  public static function x_core_next_posts_attributes($attr) {
   ...
   */
  public static function x_core_cleanup_script_tags($tag) {
