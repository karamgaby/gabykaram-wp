...
class Axio_Core_Security_Remove_Comment_Moderation extends Axio_Core_Sub_Feature {
  ...
  public function setup() {
    ...
    // var: key
    $this->set('key', 'x_core_security_remove_comment_moderation');
  ...
  public function run() {
    ...
    add_filter('comment_moderation_recipients', array($this, 'x_core_comment_moderation_post_author_only'), 11, 2);
   ...
   */
  public static function x_core_comment_moderation_post_author_only($emails, $comment_id) {
