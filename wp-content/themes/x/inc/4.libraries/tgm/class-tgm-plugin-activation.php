...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		 ...
		 * @since 1.0.0
		 *
		 * @see php\core\TGMPA\\core\TGMPA\TGM_Plugin_Activation::init()
		 */
		 ...
		 * @since 2.0.0
		 *
		 * @see php\core\TGMPA\\core\TGMPA\TGM_Plugin_Activation::admin_menu()
		 * @see php\core\TGMPA\\core\TGMPA\TGM_Plugin_Activation::notices()
		 * @see php\core\TGMPA\\core\TGMPA\TGM_Plugin_Activation::styles()
		 */
		 ...
		 *@see php\core\TGMPA\TGM_Plugin_Activation::init()
		 * @see php\core\TGMPA\TGM_Plugin_Activation::install_plugins_page()
		 *
		 * @since 1.0.0
		 *
		 */
...
if ( ! class_exists( 'TGMPA_List_Table' ) ) {
	 ...
	 * @return string|boolean Plugin slug if found, false otherwise.
		 *@since      2.2.0
		 * @deprecated 2.5.0 use {@see php\core\TGMPA\TGM_Plugin_Activation::_get_plugin_data_from_name()} instead.
		 * @see        php\core\TGMPA\TGM_Plugin_Activation::_get_plugin_data_from_name()
		 *
		 */
