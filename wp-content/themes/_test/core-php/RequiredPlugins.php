...
class RequiredPlugins {
	...
	public static function getInstance(): RequiredPlugins {
	...
	private function __construct() {
		$this->load_plugins_dependencies_config();
	}

	private function load_plugins_dependencies_config() {
		$plugins = array(
			array(
	 ...
	 */
		...
		$THMPA_Main_instance = THMPA_Main::getInstance();
		$THMPA_Main_instance->tgmpa( $plugins, $config );
	}
}
